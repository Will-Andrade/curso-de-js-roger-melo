...
const getOddNumbers = oddNumber => oddNumber % 2
...
const gamesInTheCart = cart.reduce((accumulator, { name }) => 
`${accumulator}- ${name}\n`, '');
...
const moviesLaunchedBefore2000s = tarantinoMovies.filter(({ release }) => release < 2000);
